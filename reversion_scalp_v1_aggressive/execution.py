from reversion_scalp_v1_aggressive.config import LEVERAGE, RISK_PER_TRADE, FEE_PCT, SLIPPAGE_PCT, MAX_NOTIONAL_MULTIPLIER, MAX_SYMBOL_NOTIONAL, MIN_NET_EDGE_MULTIPLIER
...
def build_trade(signal, balance):
    ...
    if signal['direction'] == 'LONG':
        gross_tp = (signal['tp'] - signal['entry']) * size
    else:
        gross_tp = (signal['entry'] - signal['tp']) * size
    total_cost = fee + slip
