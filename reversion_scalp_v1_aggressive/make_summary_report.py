...
LOG_PATH = Path('reversion_scalp_v1_aggressive/data/bot.log')
DB_PATH = Path('reversion_scalp_v1_aggressive/data/trades.db')
OUT_PATH = Path('reversion_scalp_v1_aggressive_summary.txt')
