...
class Settings(BaseModel):
    ...
    min_fill_ratio: float = float(os.getenv('MIN_FILL_RATIO', '0.30'))
    entry_threshold_pct: float = float(os.getenv('ENTRY_THRESHOLD_PCT', '0.18'))
    exit_threshold_pct: float = float(os.getenv('EXIT_THRESHOLD_PCT', '0.06'))
    ...
    max_cancel_rate: float = float(os.getenv('MAX_CANCEL_RATE', '0.90'))
    top_pairs_limit: int = int(os.getenv('TOP_PAIRS_LIMIT', '12'))
    ranking_min_signals: int = int(os.getenv('RANKING_MIN_SIGNALS', '50'))
